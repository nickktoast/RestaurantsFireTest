...
public class DisplayRestaurants extends AppCompatActivity {
    ...
    private static final String PIC_API_BASE = "https://maps.googleapis.com/maps/api/place/photo?" +
            "maxwidth=400&photorefernce=";
    private static final String API_PART = "&key=";
